...
public class SetGoalPage extends TemplateFrame {
    private int START_WEIGHT, GOAL_WEIGHT;
    ...
    public SetGoalPage(LocalDate date){
        ...
        addTextField("What is your goal weight (lbs)?", goalWeight, 0, 1);
        ...
        centerPanel.add(setGoal);
        //add a sleep & cal goal --> update progress bar
